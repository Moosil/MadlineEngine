...
void VkUtil::transitionImage(VkCommandBuffer cmd, VkImage image, VkImageLayout currentLayout, VkImageLayout newLayout) {
	...
	imageBarrier.srcStageMask = VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT;//TODO make more specific https://github.com/KhronosGroup/Vulkan-Docs/wiki/Synchronization-Examples
